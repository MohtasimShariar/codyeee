            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="text-2xl font-medium title-font mb-4 text-gray-900 tracking-widest">OUR TUTORS</h1>
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">These amazing tutors are excited to teach you the latests technologies. </p>
                    </div>
